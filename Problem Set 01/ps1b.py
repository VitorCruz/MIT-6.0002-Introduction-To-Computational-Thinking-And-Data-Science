...
SINCE THERE ARE NO COMBINATIONS HERE AND YOU CAN TAKE ANY AMOUNT OF ANY EGG, GOING FROM HEAVIEST TO LIGHTER IN ORDER AND PUTTING ALWAYS THE HEAVIEST EGG POSSIBLE
